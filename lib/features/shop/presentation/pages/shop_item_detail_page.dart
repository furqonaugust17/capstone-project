...
class _ShopItemDetailView extends StatelessWidget {
  ...
  void _showPurchaseDialog(BuildContext context, String message, {bool isSuccess = false}) {
    showDialog(
      context: context,
      builder: (ctx) => AlertDialog(
        title: Text(isSuccess ? 'Berhasil' : 'Gagal', style: AppTextStyles.headingMedium),
            ...
            builder: (context, state) {
              ...
              return ElevatedButton(
                onPressed: isProcessing
                    ? null
                    : () {
                        context.read<PurchaseCubit>().buyItem(item.id);
                      },
